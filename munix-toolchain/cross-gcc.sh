...
echo "Building GCC for native installation targetting $TARGET, installed into $HDD_SYSROOT$VIRTPREFIX"
...
pushd build || bail
    ...
    pushd gcc-native || bail
        ...
        touch $HDD_SYSROOT/usr/include/fenv.h
